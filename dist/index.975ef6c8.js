...
console.log((0, _validatePasswordDefault.default)("wefnjewkvn"));
...
// console.log(value);
// console.log(name);
console.log(_apiService);

},{"./js/validate-password":"fQf7l","./js/api-service":"RTflJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fQf7l":[function(require,module,exports) {
// ? дефолтный экспорт
// export default 555;
...
const passSchena = (0, _joiDefault.default).string().min(3).max(10);
...
parcelHelpers.export(exports, "updateUsersById", ()=>updateUsersById);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire4140")
